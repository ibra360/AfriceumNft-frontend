    ...
    return (
        <div className="mb-32 text-br-dark-blue">
            <form className="flex flex-col w-full mt-8" onSubmit={(e) => { console.log(e) }}>
                <label htmlFor="imageUpload" className="font-bold text-left">Upload file <span className="text-br-primary">*</span></label>
                <div className="relative p-10 mt-2 border-2 border-gray-800 border-dashed rounded-3xl">
                    ...
                    {formValue?.image === null && <><p>JPG, PNG, OGG, WEBM, GIF (Max 5MB)</p>
                ...
                <div className="flex justify-between mt-8">
                    ...
                    <span className="text-gray-800">250</span>
                </div>
                ...
                <div className="flex items-center mt-8 mb-4 mr-4 font-bold ">
                    ...
                    <label htmlFor="fixedPriceChoice" className="flex items-center cursor-pointer">
                        <span className="inline-block w-4 h-4 mr-1 border border-black rounded-full"></span>
                        Fixed price</label>
                </div>
                ...
                {!formValue.auctionable && <div className="flex flex-col flex-1 mt-8">
                    <label htmlFor="count" className="font-bold text-left">Number of editions <span className="text-br-primary">*</span> </label>
                ...
                <div className={classNames("fixed bottom-0 left-0 right-0 z-30 px-4  lg:z-0 lg:px-0 lg:p-0 lg:relative", isProcessing && 'opacity-60') } >
                    <button type="button" onClick={() => onSubmit(formValue)} className={classNames("w-full  my-6 font-bold border px-6 py-2 mt-10 text-base  text-black cursor-pointer main-btn shadow-white rounded-3xl lg:my-8 bg-opacity-80 hover:bg-opacity-95 hover:text-blue-900", isProcessing && 'opacity-60 bg-blue-800')} >Create</button>
                </div>
